+TITLE: Patrick´s GNU Emacs Config
#+Author: Patrick Castle
#+DESCRIPTION: First EMACS config file
...
- [[#ellama][ELLAMA]]
- [[#fonts][FONTS]]
  - [[#seting-the-font-face][Seting the Font Face]]
...
- [[#identation-problem][IDENTATION PROBLEM]]
- [[#neotree][NEOTREE]]
- [[#org-mode][Org MODE]]
  - [[#enablign-table-of-contents][Enablign Table of Contents]]
...
* ELLAMA
For interacting with LLM's on Emacs.
...
Org mode source blocks have some really weird and annoying defult indentation behavior. I think it has to do with the electric-indent-mode, wich is turned on by default in Emacs. Let's turn it off
...
Este comando nos permite movernos más rapido sobre la creacion de bloques de codigo fuente y otros. Por ejemplo el codigo fuente se crea así <s y un tab. Que no se olvide especificar el lenguaje.
#+begin_src emacs-lisp
(require 'org-tempo)
#+end_src
* PROYECTILE
